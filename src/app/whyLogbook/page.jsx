...
const WhyLogbook = () => {
    return (
        <div className="w-full flex justify-center py-10">
            <div className=" w-[90%] md:w-[60%] flex flex-col  gap-y-6">

                <h1 className=" font-bold text-lg md:text-3xl text-accentNormal">چرا باید لاگ‌ بوک داشته باشیم؟</h1>
                <span className=" w-full h-40 md:h-96 md:px-0 flex justify-center">
