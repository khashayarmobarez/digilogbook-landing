...
const WhyDigi = () => {
    ...
    return (
        <div className='w-full flex flex-col items-center justify-around py-10 gap-y-20 md:pt-32 md:pb-20'>
            ...
            <p className={`w-[90%] flex justify-center text-center bg-primaryNormalHover p-6 text-neutralLight rounded-3xl font-bold text-base -mt-24 md:-mt-10 md:text-3xl ${scrollPosition > 1300 ? 'animate__animated animate__fadeIn' : 'invisible'}`}>
