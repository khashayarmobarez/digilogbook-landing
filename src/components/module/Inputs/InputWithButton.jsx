...
const InputWithButton = ({icon, buttonText, placeH, Type, onSubmit, value, onChange, id, isLoading, inputClassName}) => {
    ...
    return (
            <div className={` flex flex-row-reverse relative w-[100%] h-12 px-2`}>
                <span> 
                    <Image
                    src={icon}
                    alt="icon"
                ...
                <input
                    ...
                    id={id}
                    placeholder={placeH}
                    className={`w-[100%] text-xs font-medium px-8 rounded-r-2xl rounded-l-none bg-primaryLight border border-primaryLightActive shadow-lg ${inputClassName}`}
                />
